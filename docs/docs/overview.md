...
- The **Tasks List** Base view adds a native-styled hierarchical workspace with arbitrary project roots, a collapsible complete-project overview, and controlled server-backed task actions.
